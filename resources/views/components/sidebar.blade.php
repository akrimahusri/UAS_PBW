...
<aside class="h-full overflow-y-auto flex flex-col">
    <div class="p-6 flex-shrink-0">
        <div class="flex items-center justify-between mb-6">
            <a href="{{ route('dashboard') }}">
                <img src="{{ asset('images/cooklab-icon.png') }}" alt="CookLab Icon" class="h-12 w-auto">
            </a>
    ...
    <nav class="flex-grow overflow-y-auto px-6 pb-6">
        {{-- Bagian Fitur --}}
        <div>
